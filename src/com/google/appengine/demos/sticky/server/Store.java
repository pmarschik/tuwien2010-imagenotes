...
public class Store {
    ...
    public class Api {
         ...
         *
         * @param user the user for which an author object is needed
         ...
         *
         * @param author the author to be persisted
         ...
         *
         * @param surface the surface to be persisted
    ...
    public static class Author {
         ...
         *
         * @param surface the surface the author is being granted access to.
         */
    ...
    public static class Note {
         ...
         * Create a new note.
         *
         * @param owner  the author who created this note
         * @param x
         * @param y
         * @param width
         * @param height
