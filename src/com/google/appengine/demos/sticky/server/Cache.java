...
public class Cache {
     ...
     * Creates a new cache.
     *
     * @param memcache the memcache service to use for caching objects
     */
     ...
     *
     * @param surfaceKey the key for the surface
     */
     ...
     *
     * @param user       the user requesting access to the cache entry
     * @param surfaceKey they key for the surface
     ...
     *
     * @param surfaceKey the key of the surface
     ...
     *
     * @param user       the user that should be given access to the cache entry
     * @param surfaceKey the key for the surface
     * @param notes      the collection of notes to cache
     ...
     *
     * @param email       the user's email
     * @param surfaceKeys a collection of surface keys
