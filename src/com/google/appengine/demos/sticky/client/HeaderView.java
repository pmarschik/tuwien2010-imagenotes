...
public class HeaderView extends FlowPanel implements Model.DataObserver,
    ...
    private class EditController implements BlurHandler, KeyPressHandler,
        ...
        private class PendingAuthorView extends SimplePanel implements
             ...
             * Constructor.
             *
             * @param name the name to display while the model saves the change on the
             *             server
             */
         ...
         * Constructor.
         *
         * @param model     the model to use for persisting changes
         * @param images    a bundle of images to be used for internal widgets
         * @param styleName the style name to be applied to the text box
         */
         ...
         *
         * @param contents the initial contents for the text box
         */
    ...
    private static class LoginInfoView extends FlowPanel implements ClickHandler {
         ...
         * @param logoutUrl a url that can be used to logout
         */
    ...
    private static class SurfaceListViewController implements ClickHandler,
        ...
        /**
         * @param model     the model to which the enclosed {@link SurfaceListView} will
         *                  communicate.
         * @param images    a bundle of images used for internal Ui elements
         * @param styleName a style name for the enclosed {@link ToggleButton}
         */
