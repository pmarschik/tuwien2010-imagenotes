...
public class Surface implements Serializable {
     ...
     *
     * @param model the model to which this surface is bound
     ...
     * @param title         the surface's title
     * @param authorNames   the names of all the authors
     * @param noteCount     the number of notes on this surface
     * @param lastUpdatedAt the time the surface was last modified on the server
     */
     ...
     *
     * @param model a model that is needed to determine the current user
     * @return
     */
     ...
     *
     * @param model the model to which this object is bound
     */
