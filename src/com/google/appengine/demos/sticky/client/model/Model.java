...
public class Model {
    ...
    public interface DataObserver {
         ...
         *
         * @param notes all the {@link Note}s on the currently selected {@link Surface}.
         */
         ...
         *
         * @param nowSelected the surface that is now selected
         * @param wasSelected the surface that was previously selected
         */
         ...
         * server.
         *
         * @param surfaces all the surfaces where the current author is a member
         */
    ...
    public interface LoadObserver {
         ...
         *
         * @param model the newly loaded model
         */
    ...
    public interface StatusObserver {
         ...
         *
         * @param description a description of the task that is starting
         */
     ...
     *
     * @param loadObserver   a callback to receive load events
     * @param statusObserver a callback to receive status events
     */
     ...
     *
     * @param surface  the surface to which the author will be added
     * @param email    the email address of the person to add
     * @param callback a callback to report success/failure to the caller
     */
