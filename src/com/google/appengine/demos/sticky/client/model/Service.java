...
public interface Service extends RemoteService {
    ...
    static class AddAuthorToSurfaceResult implements Serializable {
         ...
         * server.
         *
         * @param authorName the name of the author that was added to the surface
         * @param updatedAt  the new last updated time for the surface
         */
    ...
    static class CreateObjectResult implements Serializable {
         ...
         * server.
         *
         * @param key        the key that was assigned to the new {@link Note}
         * @param updateTime the time assigned to {@link Note#getLastUpdatedAt()}
         */
    ...
    static class GetSurfacesResult implements Serializable {
         ...
         *
         * @param timestamp an opaque timestamp
         * @param surfaces  a list of surfaces for the current author
         */
    ...
    static class UserInfoResult implements Serializable {
         ...
         * @param surface   the initially selected {@link Surface}
     ...
     *
     * @param surfaceKey the key of the surface being modified
     * @param email      the email address of the author being added
     ...
     *
     * @param noteKey they key of the note to modify
     * @param content the new content to assign
     ...
     *
     * @param noteKey the key of the note to modify
     ...
     *
     * @param surfaceKey the key of the surface where this note will be created
     * @param x          the x position for the new note
     * @param y          the y position for the new note
     * @param width      the width of the new note
     * @param height     the height of the new note
     * @return a result object
     * @throws AccessDeniedException
     */
     ...
     *
     * @param surfaceKey the surface to query
     * @param timestamp  an opaque timestamp
     * @return
     * @throws AccessDeniedException
     */
