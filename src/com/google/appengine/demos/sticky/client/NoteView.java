...
class NoteView extends SimplePanel implements Note.Observer,
		MouseUpHandler, MouseDownHandler, MouseMoveHandler,
		Model.SuccessCallback, ValueChangeHandler<String>,
	 ...
	 *            the note to render
	 */
	public NoteView(Note note, Model model,NoteSelectionCallback callback) {
